...
def preparation_time_in_minutes(number_of_layers):
    ...
    Function that accepts the number of layers and returns the total time needed to prepare.
    """
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    Function that takes total number of layers and elapsed bake time, and returns
    the length of time remaining until lasanga is complete.
    """
